...
export default function DearMJournal() {
    ...
    return (
        <div className="flex flex-col font-satoshi font-bold mx-auto">
            <div className="bg-gradient-to-b from-[#f7e5f0] to-white flex-grow flex flex-col items-center md:py-14 lg:py-20">
                <div className="flex flex-col items-center md:flex-row md:justify-center w-full max-w-7xl px-8">
                    <div>
                        <p className="text-night pb-1 md:text-4xl lg:text-6xl">Dear.M Journal</p>
                        <p className="text-night md:text-2xl md:text-nowrap lg:text-4xl">Journal Web Application</p>
                    </div>
