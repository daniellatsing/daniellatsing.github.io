...
export default function MotorVerse() {
    ...
    return (
        <div className="flex flex-col font-satoshi font-bold mx-auto">
            <div className="bg-gradient-to-b from-[#576699] to-white flex-grow flex flex-col items-center py-14">
                <div className="flex flex-col items-center md:flex-row md:justify-center w-full max-w-7xl px-8">
                    <div className="text-center md:text-left mb-6 md:mb-0">
                        <p className="text-white pb-1 md:text-4xl lg:text-6xl">MotorVerse</p>
                        <p className="text-night md:text-2xl md:text-nowrap lg:text-4xl">CarMax Mobile App Redesign</p>
                    </div>
