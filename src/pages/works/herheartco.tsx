...
export default function MSA() {
    ...
    return (
        <div className="flex flex-col font-satoshi font-bold mx-auto">
            <div className="bg-gradient-to-b from-[#f7b4a4] to-white flex-grow flex flex-col items-center py-20">
                <div className="flex flex-col items-center md:flex-row md:justify-center w-full max-w-7xl px-8">
                    <div className="text-center md:text-left mb-6 md:mb-0">
                        <p className="text-night pb-1 md:text-4xl lg:text-6xl">HerHeartCo</p>
                        <p className="text-night md:text-2xl md:text-nowrap lg:text-4xl">Mobile Application</p>
                    </div>
                ...
                <div className="text-sm grid grid-rows-1 justify-items-center max-w-7xl mx-auto px-8 text-center md:grid-cols-3 md:gap-y-8 lg:grid-cols-[repeat(5,1fr)] lg:gap-x-8 lg:text-lg lg:text-left">
                    <div>
            ...
            <div className="self-center max-w-4xl mt-20 mb-8">
                <p className="text-davys-grey text-4xl text-center md:px-20 lg:text-left">
